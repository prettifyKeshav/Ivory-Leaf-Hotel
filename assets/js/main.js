$(function () {
    ...
    //
    $(".dropdown-input select").on("change", function () {
        if ($(this).val().trim() !== "") {
            $(this).addClass("valid");
        } else {
    ...
    // facilities-swiper START ======================>
    new Swiper('.facilities-swiper-slide', {
        loop: false,
        navigation: {
            prevEl: '.facilities-swiper-slide-prev',
            nextEl: '.facilities-swiper-slide-next',
        },
        breakpoints: {
            0: {
                slidesPerView: 1.2,
    ...
    // facilities-swiper END ======================>

    // facilities-swiper START ======================>
    new Swiper('.location-advantages-slide', {
        loop: false,
        navigation: {
            prevEl: '.location-advantages-slide-prev',
            nextEl: '.location-advantages-slide-next',
        },
        breakpoints: {
            0: {
                slidesPerView: 1.2,
    ...
    // report-detail START ======================>
    new Swiper('.report-detail-swiper', {
        loop: true,
        navigation: {
            prevEl: '.report-detail-swiper-slide-prev',
            nextEl: '.report-detail-swiper-slide-next',
        },
        centeredSlides: true,
        breakpoints: {
            0: {
